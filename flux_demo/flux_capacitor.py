...
with open('flux_header.h', 'w') as fout:
    ...
    fout.write('#define FLUX_STEP ((now / FLUX_FRAME_MS) % {})\n'.format(frame_ms, lights))
    ...
    fout.write('#define FLUX_TIME (((now - switch_start) * FLUX_ON_COUNT) / (FLUX_FRAME_MS * FLUX_POWER_UP_LOOPS))\n')
    fout.write('\n')
